...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=aarch64 --target-os=linux --enable-cross-compile --cross-prefix=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android- --sysroot=../../prebuilts/ndk/current/platforms/android-19/arch-arm64 --enable-shared --enable-static --enable-avresample --extra-cflags='-O2 -g -fgcse-after-reload -frerun-cse-after-loop -frename-registers  -Wa,--noexecstack  -fno-short-enums  -no-canonical-prefixes  -fno-canonical-system-headers ' --extra-ldflags='-Wl,-maarch64linux'
prefix=/usr/local
...
ARCH=aarch64
INTRINSICS=neon
CC=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
CXX=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-g++
AS=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
LD=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
DEPCC=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=../../prebuilts/misc/$(BUILD_OS)-$(HOST_PREBUILT_ARCH)/yasm/yasm
DEPYASM=yasm
AR=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-ar
ARFLAGS=rc
AR_O=$@
RANLIB=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-ranlib
STRIP=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=../../prebuilts/ndk/current/platforms/android-19/arch-arm64 -isysroot ../../prebuilts/ndk/current/platforms/android-19/arch-arm64 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC -DZLIB_CONST
CFLAGS=  -O2 -g -fgcse-after-reload -frerun-cse-after-loop -frename-registers -Wa,--noexecstack -fno-short-enums -no-canonical-prefixes -fno-canonical-system-headers -std=c99 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O2 -g -fgcse-after-reload -frerun-cse-after-loop -frename-registers -Wa,--noexecstack -fno-short-enums -no-canonical-prefixes -fno-canonical-system-headers -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-windres
DEPWINDRES=../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.8/bin/aarch64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,-maarch64linux  --sysroot=../../prebuilts/ndk/current/platforms/android-19/arch-arm64 -isysroot ../../prebuilts/ndk/current/platforms/android-19/arch-arm64 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
